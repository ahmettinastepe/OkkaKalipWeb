...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": artan sütunları sıralamak için etkinleştir",sSortDescending:": azalan sütunu sıralamak için etkinleştir"},oPaginate:{sFirst:"İlk",sLast:"Son",sNext:"Sonraki",sPrevious:"Önceki"},sEmptyTable:"Tabloda veri yok",sInfo:"_TOTAL_ girişten _START_ - _END_ arasındakiler gösteriliyor",sInfoEmpty:"0 girdiden 0 ile 0 arası gösteriliyor",sInfoFiltered:"(_MAX_ toplam girişten filtrelendi)",sInfoPostFix:"",sDecimal:"",
    sThousands: ",", sLengthMenu: "_MENU_ girişlerini göster", sLoadingRecords: "Yükleniyor...", sProcessing: "İşleniyor...", sSearch: "Ara:", sSearchPlaceholder: "", sUrl: "", sZeroRecords:"Hiçbir eşleşen kayıt bulunamadı"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};$(n.defaults);n.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc",
